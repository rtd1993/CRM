...
if ($filter_assegnato !== '') {
    if ($filter_assegnato === 'none') {
        $sql .= " AND (t.assegnato_a IS NULL OR t.assegnato_a = 0 OR t.assegnato_a = '')";
...
<div class="task-controls">
    <div style="display: flex; width: 100%; justify-content: space-between; align-items: center; gap: 1rem; flex-wrap: wrap;">
        <form method="get" class="search-form" style="display: flex; gap:0.5rem; align-items: center; flex: 1; min-width: 0;">
            ...
            assegnazione<select name="assegnato_a" class="search-input" style="min-width:140px;">
            ...
            fatturabilità<select name="fatturabile" class="search-input" style="min-width:120px;">
                <option value="">Tutti</option>
