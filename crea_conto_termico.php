    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("
                ...
                (cliente_id, anno, numero_pratica, data_presentazione, tipo_intervento, esito, 
                 prestazione, incassato, user, password, modello_stufa, data_termine, mese, 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="numero_pratica" name="numero_pratica" 
                                       value="<?= htmlspecialchars($_POST['numero_pratica'] ?? '') ?>"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="data_presentazione" name="data_presentazione" 
                                       value="<?= htmlspecialchars($_POST['data_presentazione'] ?? '') ?>">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="stato" name="stato">
                                    <option value="bozza" <?= ($_POST['stato'] ?? 'bozza') == 'bozza' ? 'selected' : '' ?>>Bozza</option>
                                    <option value="presentata" <?= ($_POST['stato'] ?? '') == 'presentata' ? 'selected' : '' ?>>Presentata</option>
                                    <option value="istruttoria" <?= ($_POST['stato'] ?? '') == 'istruttoria' ? 'selected' : '' ?>>Istruttoria</option>
                                    <option value="accettata" <?= ($_POST['stato'] ?? '') == 'accettata' ? 'selected' : '' ?>>Accettata</option>
                                    <option value="respinta" <?= ($_POST['stato'] ?? '') == 'respinta' ? 'selected' : '' ?>>Respinta</option>
                                    <option value="liquidata" <?= ($_POST['stato'] ?? '') == 'liquidata' ? 'selected' : '' ?>>Liquidata</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="tipo_intervento" name="tipo_intervento" 
                                       value="<?= htmlspecialchars($_POST['tipo_intervento'] ?? '') ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="importo_ammissibile" name="importo_ammissibile" 
                                       step="0.01" min="0"
                                       value="<?= htmlspecialchars($_POST['importo_ammissibile'] ?? '') ?>"
                                       placeholder="0.00">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="contributo" name="contributo" 
                                       step="0.01" min="0"
                                       value="<?= htmlspecialchars($_POST['contributo'] ?? '') ?>"
                                       placeholder="0.00">
                            </div>
                        </div>
